...
class Bus_Model extends CI_Model{
    ...
    function get_tran_line_id(){
    	$query = $this->db->get_where(self::TBL_LINE, array('is_transfer' => 1));
        return $query->row_array();
    }
    ...
    function update_price_by_condition($cond, $price, $discount = null,$is_allow_return){
        $wdiscount = ", discount={$discount},is_allow_return = {$is_allow_return}";
