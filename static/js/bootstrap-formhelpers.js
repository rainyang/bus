 ...
 * ========================================================== */
 ...
 //+号是为了让定义的匿名函数执行，如同我们用(function(){})()一样，是把function变成表达式.同样有很多用！的。
+function ($) {
...
//严格模式
  ...
  var BFHCountries = function (element, options) {
    //合并options，使用户自定义option覆盖default
...
+function ($) {
  ...
  $(window).on('load', function () {
    $('select.bfh-states, span.bfh-states, div.bfh-states').each(function () {
      var $states;
